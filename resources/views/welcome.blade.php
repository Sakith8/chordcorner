    ...
    <nav id="nav-color" class="navbar navbar-expand-lg navbar-dark ">
        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                <div class="nav-item">
                    @auth
                        <a href="{{ url('/homepage') }}" id="home-name1" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Home</a>
                    @else
                        <a href="{{ route('login') }}" id="home-name1" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"  id="home-name1" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
      ...
      <div class="row">
         <div class="col-md-4">
            <div class="box1">
               ...
               <div class="detail-box">
                  ...
                  <p>
                     Get your products delivered to your doorstep for free. We ensure fast and reliable delivery services.
                  </p>
               </div>
            </div>
         </div>
         <div class="col-md-4">
            <div class="box1">
               ...
               <div class="detail-box">
                  ...
                  <p>
                     We pride ourselves on offering the best quality products. Your satisfaction is our top priority.
                  </p>
               </div>
            </div>
         </div>
         <div class="col-md-4">
            <div class="box1">
               <div class="img-box">
               <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 512 512">
   <path d="M256 0C115.39 0 0 115.39 0 256s115.39 256 256 256 256-115.39 256-256S396.61 0 256 0zm104 344H160v-24h200v24zm0-56H160v-24h200v24zm0-56H160v-24h200v24zm0-56H160v-24h200v24z"/>
</svg>
               ...
               <div class="detail-box">
                  ...
                  <p>
                     We offer free tutoring sessions for beginners. Learn from experts and kickstart your journey with us.
                  </p>
               </div>
            </div>
         </div>
